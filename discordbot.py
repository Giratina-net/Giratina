...
async def uma(ctx):
    if ctx.author.bot:
        return
    results = []    
    three_star = ["スペシャルウィーク", "サイレンススズカ", "トウカイテイオー", "マルゼンスキー", "オグリキャップ", "タイキシャトル", "メジロマックイーン", "シンボリルドルフ", "ライスシャワー", "テイエムオペラオー", "ミホノブルボン", "トウカイテイオー(新衣装)", "メジロマックイーン(新衣装)", "カレンチャン", "ナリタタイシン", "スマートファルコン", "ナリタブライアン", "マヤノトップガン(花嫁/新衣装)", "エアグルーヴ(花嫁/新衣装)", "セイウンスカイ", "ヒシアマゾン", "エルコンドルパサー(新衣装)", "グラスワンダー(新衣装)", "フジキセキ", "ゴールドシチー", "水着スペシャルウィーク", "水着マルゼンスキー", "メイショウドトウ", "エイシンフラッシュ", "マチカネフクキタル(新衣装)", "ヒシアケボノ", "アグネスデジタル", "ライスシャワー(ハロウィン)", "スーパークリーク(ハロウィン)", "カワカミプリンセス", "マンハッタンカフェ", "シンボリルドルフ(新衣装)", "ゴールドシチー(新衣装)", "トーセンジョーダン", "メジロドーベル", "ビワハヤヒデ(クリスマス)", "ファインモーション", "タマモクロス", "ハルウララ(新衣装)", "テイエムオペラオー(新衣装)", "サクラチヨノオー", "ミホノブルボン(新衣装)", "エイシンフラッシュ(新衣装)", "メジロアルダン", "アドマイヤベガ", "キタサンブラック", "サトノダイヤモンド", "メジロブライト", "セイウンスカイ(新衣装)", "フジキセキ(新衣装)", "ニシノフラワー", "ヤエノムテキ", "ナイスネイチャ(新衣装)", "キングヘイロー(新衣装)", "アイネスフウジン", "メジロパーマー", "カレンチャン(新衣装)", "ファインモーション(新衣装)"]
